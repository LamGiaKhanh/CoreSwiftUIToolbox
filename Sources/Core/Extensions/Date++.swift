...
//  Core
//
//  Created by xuanbach on 02/07/2022.
//
...
public extension Date {
    ...
    func timeAgoDisplay() -> String {
        ...
        return formatter.localizedString(for: self, relativeTo: Date().addingTimeInterval(3))
    }
...
public extension Date {
   func getFormattedDate(format: CustomDateFormatType) -> String {
        let dateformat = DateFormatter()
       dateformat.dateFormat = format.stringFormat
