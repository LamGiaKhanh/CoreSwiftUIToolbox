...
public struct PaginatedScrollView<Content: View>: View {
    ...
    @SwiftUI.Environment(\.reload) public var reloadAction: ReloadAction?
    private var canRefresh: Bool { reloadAction != nil }
    @SwiftUI.Environment(\.loadMore) public var loadMoreAction: LoadMoreAction?
    ...
    public var body: some View {
        GeometryReader { geometry in
            ScrollView(showsIndicators: false) {
                ...
                .background(Color.clear.height(99999))
